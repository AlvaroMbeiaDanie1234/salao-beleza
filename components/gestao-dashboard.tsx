                    ...
                    <div className="p-8 pt-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-t border-rose-100 pt-5 gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          <Link
                            href={`/${s.slug}`}
                            className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-rose-600 to-pink-600 px-6 py-2.5 text-xs font-bold text-white transition hover:opacity-90 shadow-md shadow-rose-500/20"
                          >
